...
public enum AssetContants {
    ...
    BC_13("流动负债合计","total_current_liabilities"),BC_14("长期借款","long_term_borrowing"),BC_15("应付债券","bonds_payable"),
    ...
    PR_19("每股收益","earnings_per_share"),PR_20("基本每股收益","earnings_per_share_basic"),PR_21("稀释每股收益","earnings_per_share_attenuation"),PR_22("营业外支出","operating_outer_cost"),

    FW_02("销售商品、提供劳务收到的现金","selling_goods_and_providing_services_cash"),FW_03("收到的税费返还","refun_of_tax_levies"),
    ...
    FW_10("经营活动现金流出小计","cash_outflow_operating_activities"),FW_11("经营活动产生的现金流量净额","net_cash_flow_from_operating_activities"),
    ...
    FW_26("吸收投资收到的现金","receipts_equity_securities"),FW_27("子公司吸收少数股东投资收到的现金","subsidiaries_receive_cash_from_minority_investors"),
